            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">SMART QR</h1>
                        <p class="">Log in to your account to continue.</p>
                        <?php if(session('message')): ?>
                        <div class="alert alert-warning"><?php echo e(session('message')); ?></div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g Jeff Dev" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a class="forgot-pass-link" href="<?php echo e(route('password.request')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="signup-link">Not registered ? <span style="font-size: 16px; font-weight: 800;">Send email to Admin!</span></p> 
...
</html><?php /**PATH D:\xampp\htdocs\capstone2\resources\views/auth/login.blade.php ENDPATH**/ ?>