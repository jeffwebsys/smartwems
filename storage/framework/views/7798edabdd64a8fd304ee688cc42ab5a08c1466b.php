...
<?php $__env->startSection('title','Service Request List'); ?>
...
<script>
   $(document).ready(function () {
    $(".search-input").on("keyup", function () {
        ...
        if (_q.length >= 3) {
            $.ajax({
                url: "<?php echo e(route('staff.servicelist.autocomplete')); ?>",
                data: {
                    q: _q,
                },
                dataType: "json",
...
<script>
   $(document).ready(function () {
    ...
    var table = $(".data-table").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('staff.servicelist')); ?>",
        columns: [
    ...
    $("body").on("click", ".editUser", function () {
        ...
        $.get("<?php echo e(route('staff.servicelist')); ?>" + "/" + user_id + "/edit", function (data) {
            ...
            if (result.isConfirmed) {
...

                {
                    $.ajax({
                        ...
                        url: "<?php echo e(route('staff.servicelist.openticket')); ?>",
                        type: "POST",
                        dataType: "json",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\capstone2\resources\views/staff/main/servicelist.blade.php ENDPATH**/ ?>