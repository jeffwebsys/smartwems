...
<div class="modal fade" id="editProc" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editProc" name="editProc" class="simple-example" action="<?php echo e(route('supplyofficer.printPdf')); ?>" method="POST"  target="_blank" required>
                    <?php echo csrf_field(); ?>
                    <div id="validation-errors"></div>
                    ...
                    <div class="form-row" style="margin-top: 50px; font-weight: 900; color: white; background: #2f3545;">
                        ...
                        <div class="col"  id="approved_by">Approved By: <?php echo e(auth()->user()->name); ?></div>
                    </div>
...
<script>
   $(document).ready(function () {
    ...
    var table = $(".data-table").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('supplyofficer.procurement')); ?>",
        columns: [
    ...
    $("body").on("click", ".editUser", function () {
        ...
        // var ticket_id
        $.get("<?php echo e(route('supplyofficer.procurement')); ?>" + "/" + procurement_id + "/edit", function (data) {
        ...
        $("#editProc").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('supplyofficer.printPdf')); ?>",
                    type: "POST",
                    dataType: "json",
        ...
        $("#userAssign").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('supplyofficer.procurement.store')); ?>",
                    type: "POST",
                    dataType: "json",
                    success: function (data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\capstone2\resources\views/supplyofficer/main/procurement.blade.php ENDPATH**/ ?>