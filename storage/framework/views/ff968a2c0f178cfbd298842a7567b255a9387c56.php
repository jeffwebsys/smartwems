...
<script>
    ...
    var table = $(".data-table").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('supplyofficer.equipment')); ?>",
        columns: [
    ...
    $("body").on("click", ".editUser", function () {
        ...
        $.get("<?php echo e(route('supplyofficer.equipment')); ?>" + "/" + equipment_id + "/edit", function (data) {
        ...
        $("#equipmentForm").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('supplyofficer/equipment')); ?>" + "/" + edit_equipment_id + "/update",
                    type: "PUT",
                    dataType: "json",
                    success: function (data) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
...

                {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('supplyofficer.equipment.store')); ?>" + "/" + equipment_id,
                        success: function (data) {
                            table.draw();
                        },
                        error: function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\capstone2\resources\views/supplyofficer/main/equipment.blade.php ENDPATH**/ ?>