...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" href="<?php echo e(asset('landing/images/favicon.html')); ?>">

    <!-- BOOTSTRAP -->
    <link rel="stylesheet" href="<?php echo e(asset('landing/css/bootstrap.min.css')); ?>">

    <!-- ICONS -->
    <link rel="stylesheet" href="<?php echo e(asset('landing/css/ilmosys-icon.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landing/css/icons/fontawesome/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landing/css/icons/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landing/css/icons/icon2/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landing/js/vendors/swipebox/css/swipebox.min.css')); ?>">


    <!-- THEME / PLUGIN CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('landing/js/vendors/slick/slick.css')); ?>">
...
<body id="page-top">
            ...
            <nav class="navbar-inverse navbar-lg navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        <a href="intro.html" class="navbar-brand brand"><img src="<?php echo e(asset('landing/images/logo.png')); ?>" alt="logo"></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown mm-menu">
                                <a class="page-scroll" href="<?php echo e(url('/home')); ?>">dashboard</a>
                            </li>
                ...
                <div class="container">
                    <div class="row center-content">
                        <div class="col-md-8 text-center">
                            <img src="<?php echo e(asset('landing/images/services/2.jpg')); ?>" class="pull-right img-responsive" alt="">
                        </div>
                        <div class="col-md-4">
                            <h3>OLSJ MISSION</h3>
                            <ul class="list">
    ...
    <script src="<?php echo e(asset('landing/js/vendors/slick/slick.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/jquery.easing.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/stellar.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/isotope/isotope.pkgd.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/swipebox/js/jquery.swipebox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/main.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/mc/jquery.ketchup.all.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/mc/main.js')); ?>"></script>
    <script src="<?php echo e(asset('landing/js/vendors/contact.js')); ?>"></script>
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
    <script src="<?php echo e(asset('landing/js/vendors/gmap.js')); ?>"></script>

</body>


</html><?php /**PATH D:\xampp\htdocs\capstone2\resources\views/welcome.blade.php ENDPATH**/ ?>