                                                    ...
                                                    <div class="work-section">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <span class="badge badge-secondary ml-2 mb-4"> The Ticket is On Progress </span>
                                                                @elseif($equipment->status == 3)
                                                                <span class="badge badge-secondary ml-2 mb-4"> The Ticket is Already Assigned to One Of Maintenance Staff</span>
                                                                @elseif($equipment->status == 4)
                                                                <span class="badge badge-secondary ml-2 mb-4"> The Ticket is For Approval</span>
                                                                @elseif($equipment->status == 5)
                                                                <span class="badge badge-secondary ml-2 mb-4"> The Ticket is Marked as Complete</span>
                                                                @else
                                                                {{-- <span class="badge badge-secondary ml-2 mb-4">  </span> --}}
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
