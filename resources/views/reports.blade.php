...
<head>
	...
	<title>Equipment Depreciation Report</title>
...
<body>
	...
	<div style="margin-top: -20px">
		<div style="">
			...
			<b style="font-size: 30px; margin-top: 5px; margin-bottom: 100px; margin-left: 0px;">Depreciation report</b>
	...
	<div class="row font-12">
		<div class="columns medium-2">
			<label><strong>Equipment Description:</strong></label>
		</div>
		<div class="columns medium-4 b-b">
	...
	<div class=" request-items" style="margin-top: 20px; margin-bottom: 20px;">
		...
		<br>
		<label style="font-size: 12px; color: black">Acquisition Cost: {{ $ac }} Php</label> | 
				<label style="font-size: 12px; color: black">Salvage Value: {{ $sv }} Php</label> |
				<label style="font-size: 12px; color: black">Depreciation Value: {{ round($dv,2) }} Php</label>
	</div>
